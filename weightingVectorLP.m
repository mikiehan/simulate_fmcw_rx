function w = weightingVectorLP(inputSignal)
%weightingVectorLinearPrediction
%
%Calculates the linear prediction for a specific array with
%a specific input signal
%
%w = weightingVectorLP(inputSignal)
%
%IN
